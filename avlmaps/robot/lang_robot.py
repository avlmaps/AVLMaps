...
class LangRobot:
    ...
    def get_avlmaps_data_dirs(self):
    ...
    def load_sound_map(self, avlmaps_data_dir: str, is_real: bool = False):
        self.sound_map = SoundMap(
            avlmaps_data_dir,
            self.config["sound_data_collect_params"]["difficulty"],
            self.config["sound_config"],
            self.config["params"]["sound_map_config"],
            self.config["sound_data_collect_params"]["is_ambiguous_data"],
            is_real=is_real,
        )
