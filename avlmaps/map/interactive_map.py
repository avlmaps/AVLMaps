...
from avlmaps.utils.habitat_utils import tf2agent_state
...
class InteractiveMap:
    ...
    def collect_map_positions(
        ...
        self.ax = plt.gca()
        self.ax.set_title(
            "Please select two points in the image to indicate the robot's starting position and orientation. Press 'Q' to quit."
        )
        self.circles_list = []
        self.coords = []
        self.start_ids = [0]
